...
local function vanilla_layout_page_2()
    ...
    for i = COURSE_BITDW,COURSE_BITS do
        ...
        table.insert(layout,{type = "text",text = "B" .. i-COURSE_BITDW+1,x = 3*(i-COURSE_BITDW)*pt,y = y})
        table.insert(layout,{type = "font",font = FONT_HUD})
        table.insert(layout,{type = "color",r = 255, g = 255,b = 255, a = 255})
        table.insert(layout,{type = "star",course = i,star_num = 0,x = 3*(i-COURSE_BITDW)*pt,y = y + rowHeight})
    end
    ...
    for i = COURSE_COTMC, COURSE_VCUTM do
        ...
        table.insert(layout,{type = "font",font = FONT_HUD})
        table.insert(layout,{type = "color",r = 255, g = 255,b = 255, a = 255})
        table.insert(layout,{type = "star",course = i,star_num = 0,x = x,y = y + rowHeight})
    end

    table.insert(layout,{type = "star",course = COURSE_SA,star_num = 0,x = 0,y = rowHeight*9})


    y = rowHeight * 11
    table.insert(layout,{type = "star",course = COURSE_PSS,star_num = 0,x = 0,y = y})
    table.insert(layout,{type = "star",course = COURSE_PSS,star_num = 1,x = pt,y = y})
    ...
    y = rowHeight * 15
    for s = 0,2 do
        table.insert(layout,{type = "star",course = COURSE_NONE,star_num = s,x = s * pt,y = y})
    end
    table.insert(layout,{type = "star",course = COURSE_NONE,star_num = 3,x = 6 * pt,y = y})
    table.insert(layout,{type = "star",course = COURSE_NONE,star_num = 4,x = 7 * pt,y = y})

    table.insert(layout,{type = "font",font = FONT_MENU})

    table.insert(layout,{type = "text",text = "Bowser Courses",x = 0, y = rowHeight})
    table.insert(layout,{type = "text",text = "Cap Switches",x = 0, y = rowHeight*4})
    table.insert(layout,{type = "text",text = "Secret Stars",x = 0, y = rowHeight*7})
    table.insert(layout,{type = "text",text = "Aquarium",x = 0, y = rowHeight*8})
    table.insert(layout,{type = "text",text = "Slide",x = 0, y = rowHeight*10})
    table.insert(layout,{type = "text",text = "WMotR",x = 0, y = rowHeight*12})
    table.insert(layout,{type = "text",text = "Toads",x = 0, y = rowHeight*14})
    table.insert(layout,{type = "text",text = "Mips",x = 6*pt, y = rowHeight*14})
    return layout
end
